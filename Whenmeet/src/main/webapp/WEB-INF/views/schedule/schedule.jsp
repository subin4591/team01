		...
		<c:otherwise>
			...
			<div class="schedule_page">
				...
				<div class="member_list">
					...
					<div class="member_list_content">
						<ul class=memberList>
							...
							%>
							<li>
								<!-- 모달 팝업 열기--> <a href="#" class="user_open"
									...
									<div class="member">
										...
										<div class="Uimage">
											<img src="<%=membersProfileUrl.get(i)%>"
												onError="<%=userImgErr%>" alt="유저 프로필 이미지"
												class="userProfile">
										</div>
										...
										<div class="text">
											...
											if (host == 1 || subhost == 1) {
											%>
											<img src="<%=Img%>" alt="방장 표시" class="hostMark">
											<%
											} ;
											%>
										</div>
				...
				<div class="user_modal">
					<div
						style="position: relative; top: -3px; background: #F25287; width: 100%; height: 50px;">
						<h1
							style="position: relative; font-size: 28px; margin: 3px; top: 3px; text-align: center; color: white;">사용자
							정보</h1>
					</div>
					<div class="user_modal_content">
						<img
							style="position: relative; top: -3px; width: 100%; height: 100px; object-fit: cover; z-index: 1001"
						...
						<img
							style="position: absolute; top: 60px; left: 0px; margin: 10px; z-index: 1002;"
							src="<%=userImgErr%>" onError="<%=userImgErr%>"
							alt="유저 프로필 이미지" class="userProfile">


						<form id="SubHostForm" action="/schedule/${groupId}/update"
							method="POST">
							<input type="text" name="userId" value="${userId}"
								style="display: None" /> <input type="text" name="subHost"
						...
						<div class="profileText"
							...
							<br>
							<br>
							<h1 class="modalUserName">정보를 불러올 수 없습니다.</h1>
							<br>
							<span>@doremiAccount</span><br>
							<br>
							<div
								style="font-size: 20px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">
								<span><b>주소 |</b><a> 도레시 미파구 솔라동 시도레 마을</a></span> <br> <span><b>전화번호
										|</b><a> 010-1234-5678</a></span> <br> <span><b>이메일 |</b><a>
										doremi@gmail.com</a></span> <br>
							</div>
						</div>
					</div>
				</div>
					...
					<div id="section_two_right">
						...
						<div id="review_btn">
							<div id="white_btn_area">
								<button type="button" id="temp" onclick="location.href='#'"
									style="margin: 5px" class="btns">비공개</button>
								<button type="button" onclick="location.href='#'"
									style="margin: 5px" class="btns">공유</button>
							</div>
				...
				<div id="second_section">
					<div id="second_btns">
						<button class="btns2" href="#" id="meeting_date_btn">미팅
							일정</button>
						<button class="btns2" href="#" id="meeting_location_btn">미팅
							위치</button>
						<button class="btns2" href="#" id="gantt_chart_btn">간트 차트</button>
						<button class="btns2" href="#" id="group_detail_btn">그룹
							정보</button>
					</div>
					<!-- 일정 탭 -->
					<div id="meeting_date">
						<div class="group_info">
							...
							<!-- 왼쪽 표 / 우클릭 금지, 드래그 금지 -->
							<div id="chart_area" oncontextmenu="return false"
								...
								<div id="timeTable" style="display: None;">
									<!-- 수정 화면 상단 날짜 이동 영역 -->
									<div id="time_table_top"
										style="margin: 10px; text-align: center;">
										<button type="button" class="total_table_left"
											onclick="slideTable(<%=slideMax%>, 0)">◀</button>
										<h2 style="display: inline;">
											<%=datesY[0]%>/<%=datesM[0]%>/<%=datesD[0]%>
											-
											<%=datesY[6]%>/<%=datesM[6]%>/<%=datesD[6]%>
										</h2>
										<button type="button" class="total_table_right"
											onclick="slideTable(<%=slideMax%>, 1)">▶</button>
										<hr
											style="width: 50%; height: 5px; background-color: #F25287; border: 0;">
									</div>
									...
									<div id="tableSlide2" style="width: 100%">
										...
										<ul>
											...
											%>
											<li>
												<table class="timeTable" border="1" bordercolor="#DDDDDD"
													width="100%" height="100%" cellspacing="0">

													<thead>
														<tr align="center"
															style="height: 54px; font-weight: bold;">
															<td style="width: 12.5%;">&nbsp;</td>
															<td style="width: 12.5%;"><span
																style="color: #F25287;"><%=datesM[0]%>/<%=datesD[0]%></span><br>
																<span style="font-size: 20px">일</span></td>
															<td style="width: 12.5%;"><span
																style="color: #F25287;"><%=datesM[1]%>/<%=datesD[1]%></span><br>
																<span style="font-size: 20px">월</span></td>
															<td style="width: 12.5%;"><span
																style="color: #F25287;"><%=datesM[2]%>/<%=datesD[2]%></span><br>
																<span style="font-size: 20px">화</span></td>
															<td style="width: 12.5%;"><span
																style="color: #F25287;"><%=datesM[3]%>/<%=datesD[3]%></span><br>
																<span style="font-size: 20px">수</span></td>
															<td style="width: 12.5%;"><span
																style="color: #F25287;"><%=datesM[4]%>/<%=datesD[4]%></span><br>
																<span style="font-size: 20px">목</span></td>
															<td style="width: 12.5%;"><span
																style="color: #F25287;"><%=datesM[5]%>/<%=datesD[5]%></span><br>
																<span style="font-size: 20px">금</span></td>
															<td style="width: 12.5%;"><span
																style="color: #F25287;"><%=datesM[6]%>/<%=datesD[6]%></span><br>
													...
													<tbody>
														...
														<tr align="center" style="font-weight: bold;">
															...
															%>
															<td rowspan="2"><span
																<%if (count == 12 || count == 24) {%> <%=spanT%> <%}%>>
																	<%=count%>:00
															</span></td>
															<%
															}
															%>
															<td style="width: 12.5%;"><div class="tdCol"
																	id="tbCol0<%=i%>"
																	onclick="javascript:tbColorChange('#tbCol0<%=i%>');"
																	alt="0"></div></td>
															<td style="width: 12.5%;"><div class="tdCol"
																	id="tbCol1<%=i%>"
																	onclick="javascript:tbColorChange('#tbCol1<%=i%>');"
																	alt="0"></div></td>
															<td style="width: 12.5%;"><div class="tdCol"
																	id="tbCol2<%=i%>"
																	onclick="javascript:tbColorChange('#tbCol2<%=i%>');"
																	alt="0"></div></td>
															<td style="width: 12.5%;"><div class="tdCol"
																	id="tbCol3<%=i%>"
																	onclick="javascript:tbColorChange('#tbCol3<%=i%>');"
																	alt="0"></div></td>
															<td style="width: 12.5%;"><div class="tdCol"
																	id="tbCol4<%=i%>"
																	onclick="javascript:tbColorChange('#tbCol4<%=i%>');"
																	alt="0"></div></td>
															<td style="width: 12.5%;"><div class="tdCol"
																	id="tbCol5<%=i%>"
																	onclick="javascript:tbColorChange('#tbCol5<%=i%>');"
																	alt="0"></div></td>
															<td style="width: 12.5%;"><div class="tdCol"
																	id="tbCol6<%=i%>"
																	onclick="javascript:tbColorChange('#tbCol6<%=i%>');"
																	alt="0"></div></td>
														</tr>
														<%
														}
								...
								<div id="total_table">
									...
									<div id="tableSlide" style="width: 100%">
										...
										<ul>
											...
											%>
											<li>
												<table class="totalTable" border="1" bordercolor="#DDDDDD"
													width="100%" height="100%" cellspacing="0">
													<thead>
														<tr align="center"
															style="height: 54px; font-weight: bold;">
							...
							<div id="Dday_area">
								<div id="Dday" style="display: None">
									<a><img class="editDate" src="/img/방장용_수정_버튼.svg" /></a> <span>D-day</span>
									<span>14</span> <span>2022년 12월 31일 (토)</span> <span>14:00
										- 15:30</span>
								</div>
								<div id="DdayInit">
									<a><img class="editDate" src="/img/방장용_수정_버튼.svg" /></a> <span>D-day가<br>아직
										등록되지 않았습니다.
									</span>
								</div>

								<div id="Dday_edit" style="display: None;">
									<img class="etc" src="/img/수정중.svg"> <img
										ID="endEditDate" src="/img/엑스.svg">
									...
									<form action="#second_section" method="get" id="Dday_frm">
										<br>
										<br> <span><a id="DdayEditDate">날짜 :
												0000-00-00</a> <input type="date" class="spanImg" id="finalDate"
											placeholder="" onchange="changeDate()" /> </span> <br>
										<br> <span><a id="DdayEditTime1">시작 시각 : 00:00</a>
											<input type="time" class="spanImg" id="finalStartTime"
											placeholder="" onchange="changeTime1()" /> </span> <br>
										<br> <span><a id="DdayEditTime2">종료 시각 : 00:00</a>
											<input type="time" class="spanImg" id="finalEndTime"
											placeholder="" onchange="changeTime2()" /> <br> <input
											type="submit" value="저장" alt=0; class="submitBtn"
											onclick="DdayUpdate()" />
									</form>
								</div>
								<%
								...
								<div id="timeTableDateEdit">
									<div id="update_date">
										<div id="updateDateView">
											<span><a class="first"><%=today%></a> <br>-<br>
									...
									<div class="week_modal">
										<div
											style="position: relative; top: -3px; background: #F25287; width: 100%; height: 50px;">
											<h1
												style="position: relative; font-size: 28px; margin: 3px; top: 3px; text-align: center; color: white;">일정표
												날짜 변경</h1>
										</div>
										<div class="week_modal_content">
											<form action="#second_section" method="get"
												id="updateWeekForm">
												<span>기간 시작일 : <input type="date" id="firstDate"></span>
												<span>기간 종료일 : <input type="date" id="EndDate" /></span> <input
													type="submit" value="저장" onclick="javasript:changeWeek();"
													class="submitBtn" />
											</form>
										</div>
									</div>
					...
					<div id="gantt_chart" style="display: none;">
						<div class="group_info">
							<div id="ganttCreate">
								<button id="ganttCreateBtn">
									<h1>
										<img src="/img/plusIcon.svg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;새로운
										차트
									</h1>
								</button>
							</div>
							...
							<div id="ganttFirstEdit" style="display: None;">
								<div id="leftGanttFirstEdit">
									<div id="GFEDate">
										<h2 style="display: inline">
											시작일 : <input type="date" name="startDate" /><br> 종료일 : <input
									...
									<div id="GFEDoIt">
										...
										<div id="DoItContainer">
											<ul style="list-style: none; margin: 0px; padding: 0">
												...
												<li>
													<div class="DoItList">
														<input type="checkbox" class="DoItCheck"
															id="DoItCheck<%=i%>" alt="0"
															onclick="openDoItList('<%=i%>')"> <label
															for="DoItCheck<%=i%>"></label>&nbsp;<%=DoIt.get(i)%>
														<img src="/img/방장용_수정_버튼.svg" class="DoItListEditBtn"
															onclick="DpopOpen('<%=DoIt.get(i)%>', '<%=DoItDetail[i]%>')" />
														<button type="button" class="deleteBtn"
															onclick="deleteBtn('<%=i%>')">✕</button>
													</div>
													<div>
														<ul class="DoItListChild" id="DoItListChild<%=i%>"
															style="display: None;">
															<%
															for (int j = 0; j < DoItDetail[i].size(); j++) {
															%>
			    ...
			    -->
								<div style="display: flex; height: 100%;">
										...
										<div id="GRDoIt">
											...
											<div id="GRDoItContainer">
												<ul style="list-style: none; margin: 0px; padding: 0">
													...
													<li>
														<div class="DoItList"
															style="background: #f25287; color: white;">
															<input type="checkbox" class="DoItCheck"
																id="DoItCheck2<%=i%>" alt="0"
																onclick="openDoItList('2<%=i%>')"> <label
																for="DoItCheck2<%=i%>"></label>&nbsp;<%=DoIt.get(i)%>
														</div>
														<div>
															<ul class="DoItListChild" id="DoItListChild2<%=i%>"
																style="display: None;">
																<%
																for (int j = 0; j < DoItDetail[i].size(); j++) {
																%>
																<li><input type="checkbox" class="DoItCheck3"
																	id="DoItCheck3<%=i%><%=j%>" alt="0"
																	onclick="GRchecked('<%=i%><%=j%>', <%=count%>)">
											...
											<div style="margin-top: 20px;">
												<h1>
													프로젝트 진행도 : <span style="color: #f25287" id="percentage">00.0</span>%
												</h1>
												<h2 style="color: #f25287; font-family: '코트라'" id="fighting">천리
													길도 한 걸음부터!</h2>
											</div>
										</div>
									</div>
									<div id="ganttResultContainer">
										<br>
										<h2 style="margin: 0px; margin-top: 2px; text-align: center">그룹
											차트</h2>
										<hr style="border: 3px solid #f25287; width: 90%">
										<div id="chart_div2_container"
											style="border: None; width: 97%; height: 65%; background: #f9f3f3; margin-top: 0px">
											<br>
			...
			$("#ganttResult").hide();
					...
					<div id="group_detail" style="display: none;">
						<div class="group_info">
							<div class="group_information"
								style="display: flex; margin: auto; background: white; width: 95%; height: 90%">
								<div
									style="display: flex; margin: auto; width: 90%; height: 80%">
									<div id="group_detail_left">
										...
										<img src="/img/액자.png"
											style="position: absolute; width: 150px; height: 150px; top: 400px" />
									</div>
									<div id="group_detail_right">
										<img src="/img/twocat.png"
											style="position: absolute; width: 200px; height: 200px; bottom: 110px; right: 120px; z-index: 0; opacity: 0.3;">
										<br>
										<br>
										<div>
											<h2>
					...
					<div class="DoIt_modal">
						<div
							style="position: relative; top: -3px; background: #F25287; width: 100%; height: 50px;">
							<h1
								style="position: relative; font-size: 28px; margin: 3px; top: 3px; text-align: center; color: white;"
								class="modalDoItName">오류가 발생했습니다</h1>
						</div>
							...
							<form action="#second_section" method="get" id="updateDoItForm">
								<div style="display: flex;">
									<div id="DoItChildDate" style="margin: 10px">
										...
										<br> <input type="text" placeholder="  새 작업 추가하기"
											name="newValue" />
										<button name="newValueBtn" class="newValueBtn"
											style="width: 40px; height: 40px; font-size: 25px;">+</button>
									</div>
								...
								<input type="submit" value="저장" onclick="" class="submitBtn"
									style="left: 42%; margin-top: 10px;" />
							</form>
						</div>
					</div>
				</div>
