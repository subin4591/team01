    ...
    function renderInner$1(renderProps) {
        ...
        if(t.length == 3){
            ...
            if(t.includes("Sun")){
                ...
                t = t.replace("Mon","월");
            }else if(t.includes("Tue")){
                t = t.replace("Tue","화");
            }else if(t.includes("Wed")){
                t = t.replace("Wed","수");
            }else if(t.includes("Thu")){
                t = t.replace("Thu","목");
            }else if(t.includes("Fri")){
                t = t.replace("Fri","금");
            }else if(t.includes("Sat")){
                t = t.replace("Sat","토");
            }
            return t;
        }
    ...
    class CalendarContent extends PureComponent {
        ...
        */
        render() {
            ...
            var parts = props.viewTitle.slice(-4);
            var spaceCount = props.viewTitle.split(" ").length - 1;
            if(spaceCount == 1){
                if(props.viewTitle.includes("Jan")){
                    props.viewTitle = parts + "년 1월"
                }else if(props.viewTitle.includes("Feb")){
                    props.viewTitle = parts + "년 2월"
                }else if(props.viewTitle.includes("Mar")){
                    props.viewTitle = parts + "년 3월"
                }else if(props.viewTitle.includes("Apr")){
                    props.viewTitle = parts + "년 4월"
                }else if(props.viewTitle.includes("May")){
                    props.viewTitle = parts + "년 5월"
                }else if(props.viewTitle.includes("Jun")){
                    props.viewTitle = parts + "년 6월"
                }else if(props.viewTitle.includes("Jul")){
                    props.viewTitle = parts + "년 7월"
                }else if(props.viewTitle.includes("Aug")){
                    props.viewTitle = parts + "년 8월"
                }else if(props.viewTitle.includes("Sep")){
                    props.viewTitle = parts + "년 9월"
                }else if(props.viewTitle.includes("Oct")){
                    props.viewTitle = parts + "년 10월"
                }else if(props.viewTitle.includes("Nov")){
                    props.viewTitle = parts + "년 11월"
                }else if(props.viewTitle.includes("Dec")){
                    props.viewTitle = parts + "년 12월"
                }
            }else if(spaceCount == 2){
                var day = props.viewTitle.split(" ")[1].slice(0, -1);
                if(props.viewTitle.includes("Jan")){
                    props.viewTitle = parts + "년 1월 "+ day+"일" 
                }else if(props.viewTitle.includes("Feb")){
                    props.viewTitle = parts + "년 2월 "+ day+"일"
                }else if(props.viewTitle.includes("Mar")){
                    props.viewTitle = parts + "년 3월 "+ day+"일"
                }else if(props.viewTitle.includes("Apr")){
                    props.viewTitle = parts + "년 4월 "+ day+"일"
                }else if(props.viewTitle.includes("May")){
                    props.viewTitle = parts + "년 5월 "+ day+"일"
                }else if(props.viewTitle.includes("Jun")){
                    props.viewTitle = parts + "년 6월 "+ day+"일"
                }else if(props.viewTitle.includes("Jul")){
                    props.viewTitle = parts + "년 7월 "+ day+"일"
                }else if(props.viewTitle.includes("Aug")){
                    props.viewTitle = parts + "년 8월 "+ day+"일"
                }else if(props.viewTitle.includes("Sep")){
                    props.viewTitle = parts + "년 9월 "+ day+"일"
                }else if(props.viewTitle.includes("Oct")){
                    props.viewTitle = parts + "년 10월 "+ day+"일"
                }else if(props.viewTitle.includes("Nov")){
                    props.viewTitle = parts + "년 11월 "+ day+"일"
                }else if(props.viewTitle.includes("Dec")){
                    props.viewTitle = parts + "년 12월 "+ day+"일"
                }
            }else{
                var part = props.viewTitle.split(" ");
                var formattedParts = null;
                if(part.length == 5){
                    
                    formattedParts = [
                        part[4] + "년", 
                        part[0],
                        part[1] + "일",  // Format the second part with "th" suffix
                        part[2],
                        part[3].slice(0, -1) + "일",   // Format the third part with "th" suffix
                    ];
                }else{
                    part[4] = part[4].replace(",","");
                    formattedParts = [
                        part[5] + "년",
                        part[0],  // The first part remains the same
                        part[1] + "일",  // Format the second part with "th" suffix
                        part[2],
                        part[3],
                        part[4] + "일"   // Format the third part with "th" suffix
                        
                    ];
                }
                props.viewTitle = formattedParts.join(" ");
                
                if(props.viewTitle.includes("Jan")){
                    props.viewTitle = props.viewTitle.replaceAll("Jan","1월");
                }if(props.viewTitle.includes("Feb")){
                    props.viewTitle = props.viewTitle.replaceAll("Feb","2월");
                }if(props.viewTitle.includes("Mar")){
                    props.viewTitle = props.viewTitle.replaceAll("Mar","3월");
                }if(props.viewTitle.includes("Apr")){
                    props.viewTitle = props.viewTitle.replaceAll("Apr","4월");
                }if(props.viewTitle.includes("May")){
                    props.viewTitle = props.viewTitle.replaceAll("May","5월");
                }if(props.viewTitle.includes("Jun")){
                    props.viewTitle = props.viewTitle.replaceAll("Jun","6월");
                }if(props.viewTitle.includes("Jul")){
                    props.viewTitle = props.viewTitle.replaceAll("Jul","7월");
                }if(props.viewTitle.includes("Aug")){
                    props.viewTitle = props.viewTitle.replaceAll("Aug","8월");
                }if(props.viewTitle.includes("Sep")){
                    props.viewTitle = props.viewTitle.replaceAll("Sep","9월");
                }if(props.viewTitle.includes("Oct")){
                    props.viewTitle = props.viewTitle.replaceAll("Oct","10월");
                }if(props.viewTitle.includes("Nov")){
                    props.viewTitle = props.viewTitle.replaceAll("Nov","11월");
                }if(props.viewTitle.includes("Dec")){
                    props.viewTitle = props.viewTitle.replaceAll("Dec","12월");
                }
            }
